...
import heroVideo from '@assets/generated_videos/kahiko_dancers_kaholo_cream.mp4';
            ...
            <Card className="border shadow-lg relative bg-card">
              ...
              <CardContent className="space-y-4">
                <ul className="space-y-3">
                  {['Up to 30 Students', 'Online Registration', 'Attendance Tracking', 'Curriculum Documentation', 'Email Support'].map((item, i) => (
